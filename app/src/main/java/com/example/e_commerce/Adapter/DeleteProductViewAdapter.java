...
public class DeleteProductViewAdapter extends FirebaseRecyclerAdapter<Product,DeleteProductViewAdapter.myviewholder> {
    ...
    public DeleteProductViewAdapter(@NonNull FirebaseRecyclerOptions<Product> options) {
        super(options);
    ...
    public myviewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.deleteproductview,parent,false);
